              ...
              <div className="resort-content">
                ...
                <div className="resort-rating">
                  <div
                    ...
                    role="img"
                    aria-label={`Rated ${resort.rating} out of 5`}
                  >
                    <span style={{ width: "100%" }}>
                      Rated <strong className="rating">{resort.rating}</strong>{" "}
                      out of 5
                    </span>
                  </div>
                ...
                <h4 className="resort-price">
                  <span className="currency">From {resort.price}</span>/per
                  Night
                </h4>
                <p className="resort-text">
                  Focused on providing a serene, relaxing environment with
                  natural landscapes and coastal aesthetics.
                </p>
