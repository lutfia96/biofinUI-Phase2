      ...
      <div className="container-fluid px-0">
        <div className="text-center py-5 title-section">
          ...
          <h2 className="main-title pt-5">
            Learn how your entrance fees support conservation, communities, and
        ...
        <div className="page-content d-flex flex-column align-items-center">
          ...
          <div className="card custom-card w-100">
            <div className="card-body p-4">
              ...
              <h4 className="tour-price text-start mb-4">
                <span className="currency">$189.25</span>{" "}
                <span className="small text-light">/Person</span>
              </h4>
                ...
                <div className="col-md-6">
                  <div className="section-box gov-box h-100">
                    <h5 className="fw-bold high-light-gov mb-3">
                      <i className="bi bi-globe me-2"></i>70% Government
                      Programs
                    </h5>
                    <ul className="mb-0">
                ...
                <div className="col-12">
                  <div className="footer-box section-box">
                    <p className="mb-0 text-secondary px-3 py-3">
                      ...
                      Government programs focus on large-scale conservation
                      efforts and infrastructure, while community investments
                      create sustainable livelihoods and ensure local support
                ...
                <div className="conservation-card p-4 h-100 border rounded shadow-sm">
                  <div className="d-flex align-items-center mb-4">
                    ...
                    <h5 className="fw-bold mb-0 d-flex align-items-center">
                      <i className="bi bi-tsunami text-info me-2 fs-4"></i>{" "}
                      Marine Conservation
                    </h5>
                  </div>
                  ...
                  <div className="content-item mb-3 border-start border-4 border-info ps-3">
                    ...
                    <p className="text-secondary mb-0">
                      Preventing illegal fishing and destructive activities that
                      threaten coral reefs and marine life
                    </p>
                  </div>
                  ...
                  <div className="content-item mb-3 border-start border-4 border-primary ps-3">
                    ...
                    <p className="text-secondary mb-0">
                      Tracking reef health, marine species populations, and
                      ecosystem changes
                    </p>
                  </div>

                  <div className="content-item border-start border-4 border-teal ps-3">
                    <h6 className="fw-bold text-teal mb-1">
                      Education and Capacity Building
                    </h6>
                    <p className="text-secondary mb-0">
                      Training local communities and raising awareness about
                      marine conservation
                    </p>
                  </div>
                </div>
              ...
              <div className="col-md-6">
                <div className="conservation-card p-4 h-100 border rounded shadow-sm">
                  <div className="d-flex align-items-center mb-4">
                    ...
                    <h5 className="fw-bold mb-0 d-flex align-items-center">
                      <i className="bi bi-tree-fill text-success me-2 fs-4"></i>{" "}
                      Forest Protection
                    </h5>
                  </div>
                  ...
                  <div className="content-item mb-3 border-start border-4 border-success ps-3">
                    ...
                    <p className="text-secondary mb-0">
                      Supporting alternative livelihoods and skills training for
                  ...
                  <div className="content-item mb-3 border-start border-4 border-teal ps-3">
                    ...
                    <p className="text-secondary mb-0">
                      Preventing illegal logging and preserving biodiversity
                  ...
                  <div className="content-item border-start border-4 border-warning ps-3">
                    ...
                    <p className="text-secondary mb-0">
                      Creating sustainable tourism opportunities that benefit
          ...
          <div className="card custom-card bg-smoke2 text-center p-4 my-4 pb-5 mb-5">
            ...
            <p className="text-secondary mb-0">
              Your visit and entrance fee contribute directly to preserving
              Zanzibar’s natural beauty and supporting local communities.
              Together, we’re ensuring these treasures remain protected for
              generations to come.
            </p>
          </div>
        </div>
